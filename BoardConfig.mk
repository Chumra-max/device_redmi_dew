...
BOARD_MAIN_PARTITION_LIST := system vendor product system_ext vendor_dlkm odm_dlkm mi_ext
...
# --- Recovery ---
# No dedicated recovery partition exists (confirmed: absent from /dev/block/by-name dump) —
# this device folds recovery into the boot partition itself, standard for modern A/B devices.
